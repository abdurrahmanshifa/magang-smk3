                              ...
                              <div class="card-body table-responsive p-0" style="height: 300px;">
                                   <table class="table table-head-fixed text-nowrap">
                                        <thead>
                                             ...
                                             <tr>
                                                <td><? echo $kendaraan['id']; ?></td>
                                                <td><? echo $kendaraan['jenis_kendaraan']; ?></td>
                                                <td><? echo $kendaraan['warna_kendaraan']; ?></td>
                                                <td><? echo $kendaraan['plat_kendaraan']; ?></td>
                                                <td><? echo $kendaraan['bahan_bakar']; ?></td>
                                             </tr>
                                        </thead>
                                   </table>
                         </div>
